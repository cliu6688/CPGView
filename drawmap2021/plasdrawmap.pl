...
#
die "\n\nUsage: $0 workingdir projectid file_gb\n\nExample run: perl $0 /tmp/o10 1234 test/1234.gb \n\n " unless (-e $file_gb);
...
#my $python = "/share/apps/biosoft/anaconda2/envs/rnaedit/bin/python";
#my $python = "python";
#my $python = "/share/apps/bin/python";
#my $python = "/biodata4/home/cliu/drawgenemap/bin/python";
